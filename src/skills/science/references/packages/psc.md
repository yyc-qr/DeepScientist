# PSC Particle-in-Cell Plasma Simulator

## Catalog

- Package id: `psc`
- Domains: `electromagnetics`, `plasma_particle_simulation`, `workflow_provenance`
- Tags: `plasma-physics`, `particle-in-cell`, `electromagnetics`, `kinetic-plasma`, `hpc`, `gpu`
- Knowledge URL: https://github.com/skilled-scipkg/psc
- Source archive URL: https://github.com/skilled-scipkg/psc/archive/refs/heads/main.zip
- Upstream project URL: https://github.com/psc-code/psc
- Homepage: https://psc.readthedocs.io/en/latest/
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

PSC is a three-dimensional fully electromagnetic particle-in-cell code for kinetic plasma simulations with MPI scaling, GPU acceleration, and patch-based dynamic load balancing.
...
state and the exact executable path in `validation/environment/psc_doctor.json`.
...
Generated import or executable names are starting points. If `psc` uses
