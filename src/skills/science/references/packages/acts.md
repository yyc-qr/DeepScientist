...
- Tags: `high-energy-physics`, `particle-tracking`, `track-reconstruction`, `detector-geometry`, `simulation`, `cpp`
- Knowledge URL: https://github.com/skilled-scipkg/acts
- Source archive URL: https://github.com/skilled-scipkg/acts/archive/refs/heads/main.zip
- Upstream project URL: https://github.com/acts-project/acts
...
ACTS is a modern C++ toolkit for experiment independent charged particle track reconstruction, detector geometry, and fast tracking simulation in high energy physics workflows.
...
under `validation/environment/acts_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `acts` uses
