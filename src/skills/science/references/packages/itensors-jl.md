# ITensors.jl Tensor Network Library

## Catalog

- Package id: `itensors-jl`
- Domains: `workflow_provenance`
- Tags: `julia`, `tensor-networks`, `computational-physics`, `quantum-many-body`, `tensor-algebra`
- Knowledge URL: https://github.com/skilled-scipkg/ITensors.jl
- Source archive URL: https://github.com/skilled-scipkg/ITensors.jl/archive/refs/heads/main.zip
- Upstream project URL: https://github.com/ITensor/ITensors.jl
- Homepage: https://itensor.org
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

ITensors.jl is a Julia package for efficient index-aware tensor operations and tensor network primitives used in quantum many-body and numerical physics workflows.
...
appropriate for `itensors-jl`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/itensors-jl_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `itensors-jl` uses
