# Delphes Fast Collider Simulation

## Catalog

- Package id: `delphes`
- Domains: `high_energy_physics`
- Tags: `hep`, `collider`, `detector-simulation`, `fast-simulation`, `root`
- Knowledge URL: https://github.com/skilled-scipkg/delphes
- Source archive URL: https://github.com/skilled-scipkg/delphes/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/delphes/delphes
- Homepage: https://delphes.github.io
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

Delphes is a C++ framework for fast multipurpose collider detector-response simulation, producing reconstructed physics objects and ROOT trees from generated high-energy physics events.
...
appropriate for `delphes`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/delphes_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `delphes` uses
