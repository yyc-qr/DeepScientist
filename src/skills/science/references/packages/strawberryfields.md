# Strawberry Fields Continuous-Variable Quantum Toolkit

## Catalog

- Package id: `strawberryfields`
- Domains: `electromagnetics`
- Tags: `quantum-computing`, `photonics`, `continuous-variable`, `quantum-optics`, `circuit-simulation`, `bosonic-systems`
- Knowledge URL: https://github.com/skilled-scipkg/strawberryfields
- Source archive URL: https://github.com/skilled-scipkg/strawberryfields/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/XanaduAI/strawberryfields
- Homepage: https://xanadu.ai
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

Strawberry Fields is a Python platform for designing, simulating, and optimizing continuous-variable photonic quantum circuits, including near-term algorithms and execution pathways for quantum optical hardware.
...
appropriate for `strawberryfields`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/strawberryfields_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `strawberryfields` uses
