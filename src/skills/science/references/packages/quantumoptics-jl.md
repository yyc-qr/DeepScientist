# QuantumOptics.jl Quantum Dynamics Simulator

## Catalog

- Package id: `quantumoptics-jl`
- Domains: `computational_science`
- Tags: `quantum-optics`, `open-quantum-systems`, `julia`, `quantum-simulation`, `computational-physics`
- Knowledge URL: https://github.com/skilled-scipkg/QuantumOptics.jl
- Source archive URL: https://github.com/skilled-scipkg/QuantumOptics.jl/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/qojulia/QuantumOptics.jl
- Homepage: http://qojulia.org
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

Julia package for numerically simulating closed and open quantum systems, with tools for quantum optics models, operator algebra, and dissipative time evolution.
...
appropriate for `quantumoptics-jl`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/quantumoptics-jl_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `quantumoptics-jl` uses
