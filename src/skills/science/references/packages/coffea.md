# Coffea Collider HEP Analysis Framework

## Catalog

- Package id: `coffea`
- Domains: `finite_element_engineering`, `high_energy_physics`
- Tags: `hep`, `collider`, `columnar`, `nanoaod`, `event-analysis`, `scikit-hep`, `distributed-execution`
- Knowledge URL: https://github.com/skilled-scipkg/coffea
- Source archive URL: https://github.com/skilled-scipkg/coffea/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/scikit-hep/coffea
- Homepage: https://coffea-hep.readthedocs.io
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

Coffea provides columnar high-energy collider physics analysis tools with event processing, histogramming, corrections, and scalable execution from laptops to clusters in Python.
...
appropriate for `coffea`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/coffea_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `coffea` uses
