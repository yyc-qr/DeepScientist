...
- Tags: `open-quantum-systems`, `non-markovian`, `process-tensor`
- Knowledge URL: https://github.com/skilled-scipkg/OQuPy
- Source archive URL: https://github.com/skilled-scipkg/OQuPy/archive/refs/heads/main.zip
- Upstream project URL: https://github.com/tempoCollaboration/OQuPy
- Homepage: https://oqupy.readthedocs.io
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

Open Quantum Systems in Python package focused on non-Markovian process-tensor methods and environment-driven quantum dynamics.
...
appropriate for `oqupy`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/oqupy_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `oqupy` uses
