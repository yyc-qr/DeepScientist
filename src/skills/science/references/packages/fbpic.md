# FBPIC Spectral Quasi-3D PIC

## Catalog

- Package id: `fbpic`
- Domains: `plasma_particle_simulation`
- Tags: `plasma-physics`, `particle-in-cell`, `wakefield-acceleration`, `laser-plasma`, `spectral-simulation`, `gpu-simulation`
- Knowledge URL: https://github.com/skilled-scipkg/fbpic
- Source archive URL: https://github.com/skilled-scipkg/fbpic/archive/refs/heads/dev.zip
- Upstream project URL: https://github.com/fbpic/fbpic
- Homepage: http://fbpic.github.io
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

FBPIC is a Fourier-Bessel particle-in-cell simulator for relativistic plasma physics, optimized for laser and plasma wakefield acceleration studies on CPU and GPU.
...
```bash
command -v fbpic || true
fbpic --version || true
```

If the package is available only through environment modules, record the module
state and the exact executable path in `validation/environment/fbpic_doctor.json`.
...
Generated import or executable names are starting points. If `fbpic` uses
