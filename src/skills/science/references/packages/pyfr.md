# PyFR High-Order CFD Solver

## Catalog

- Package id: `pyfr`
- Domains: `computational_fluid_dynamics`
- Tags: `cfd`, `pde`, `flux-reconstruction`, `unstructured-mesh`, `gpu-computing`
- Knowledge URL: https://github.com/skilled-scipkg/PyFR
- Source archive URL: https://github.com/skilled-scipkg/PyFR/archive/refs/heads/develop.zip
- Upstream project URL: https://github.com/PyFR/PyFR
- Homepage: https://github.com/PyFR/PyFR
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

PyFR is a Python framework for high-order flux-reconstruction simulation of advection-diffusion governing equations on mixed unstructured meshes, optimized for CPUs and GPUs via a templated kernel language.
...
state and the exact executable path in `validation/environment/pyfr_doctor.json`.
...
Generated import or executable names are starting points. If `pyfr` uses
