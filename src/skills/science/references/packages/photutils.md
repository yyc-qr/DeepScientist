...
- Package id: `photutils`
- Domains: `astronomy_astrophysics`
- Tags: `astronomy`, `astrophotometry`, `source-detection`, `aperture-photometry`, `psf-photometry`, `image-segmentation`
- Knowledge URL: https://github.com/skilled-scipkg/photutils
- Source archive URL: https://github.com/skilled-scipkg/photutils/archive/refs/heads/main.zip
- Upstream project URL: https://github.com/astropy/photutils
...
Photutils provides robust algorithms for detecting astronomical sources and performing aperture and PSF photometry, with background estimation, segmentation, centroiding, and profile analysis for telescope image data.
...
Generated import or executable names are starting points. If `photutils` uses
