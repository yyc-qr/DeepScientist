...
- Tags: `particle-physics`, `monte-carlo`, `radiation-transport`, `detector-simulation`, `medical-physics`, `nuclear-physics`
- Knowledge URL: https://github.com/skilled-scipkg/geant4
- Source archive URL: https://github.com/skilled-scipkg/geant4/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/Geant4/geant4
- Homepage: https://geant4.org
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

Geant4 is a C++ toolkit for Monte Carlo simulation of particle interactions with matter across detector design, radiation transport, medical physics, and space science applications.
...
appropriate for `geant4`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/geant4_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `geant4` uses
