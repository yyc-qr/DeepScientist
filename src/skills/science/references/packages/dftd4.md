...
- Tags: `quantum-chemistry`, `dft`, `dispersion`, `fortran`, `electronic-structure`
- Knowledge URL: https://github.com/skilled-scipkg/dftd4
- Source archive URL: https://github.com/skilled-scipkg/dftd4/archive/refs/heads/main.zip
- Upstream project URL: https://github.com/dftd4/dftd4
...
Fortran-based implementation of the D4 atomic-charge dependent London dispersion correction for DFT, providing energies, gradients, pairwise decomposition, periodic support, and C and Python interfaces.
...
Generated import or executable names are starting points. If `dftd4` uses
