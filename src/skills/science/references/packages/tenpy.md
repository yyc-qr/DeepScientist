...
- Tags: `tensor-networks`, `quantum-many-body`, `dmrg`, `tebd`, `matrix-product-states`, `computational-physics`
- Knowledge URL: https://github.com/skilled-scipkg/tenpy
- Source archive URL: https://github.com/skilled-scipkg/tenpy/archive/refs/heads/main.zip
- Upstream project URL: https://github.com/tenpy/tenpy
...
TeNPy is a tensor-network simulation library for strongly correlated quantum many-body systems, with readable yet extensible implementations of DMRG, TEBD, and related matrix-product-state algorithms for physics research.
...
appropriate for `tenpy`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/tenpy_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `tenpy` uses
