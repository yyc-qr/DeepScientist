...
- Tags: `electronic-structure`, `density-functional-theory`, `all-electron`, `fp-lapw`, `materials-science`, `solid-state-physics`
- Knowledge URL: https://github.com/skilled-scipkg/elk
- Source archive URL: https://github.com/skilled-scipkg/elk/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/elk-code/elk
- Homepage: https://elk.sourceforge.io/
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

Elk is an all-electron full-potential linearized augmented-plane-wave code for first-principles electronic-structure calculations in solids using density functional theory and related methods.
...
state and the exact executable path in `validation/environment/elk_doctor.json`.
...
Generated import or executable names are starting points. If `elk` uses
