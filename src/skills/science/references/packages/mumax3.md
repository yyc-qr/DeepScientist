...
- Tags: `micromagnetics`, `gpu`, `spintronics`, `nanomagnetism`, `magnetization`
- Knowledge URL: https://github.com/skilled-scipkg/3
- Source archive URL: https://github.com/skilled-scipkg/3/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/mumax/3
- Homepage: https://github.com/mumax/3
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

MuMax3 is a GPU-accelerated micromagnetic simulation package for modeling magnetization dynamics, spintronic effects, and nanomagnetic device behavior using Landau-Lifshitz-Gilbert equation solvers.
...
appropriate for `mumax3`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/mumax3_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `mumax3` uses
