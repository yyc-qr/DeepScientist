...
- Tags: `openmc`, `monte-carlo`, `reactor-physics`, `nuclear-transport`, `criticality`, `radiation`
- Knowledge URL: https://github.com/skilled-scipkg/openmc
- Source archive URL: https://github.com/skilled-scipkg/openmc/archive/refs/heads/develop.zip
- Upstream project URL: https://github.com/openmc-dev/openmc
- Homepage: https://docs.openmc.org
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

OpenMC is a Monte Carlo neutron and photon transport package for reactor physics and radiation modeling using continuous energy nuclear data and constructive solid geometry.
...
appropriate for `openmc`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/openmc_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `openmc` uses
