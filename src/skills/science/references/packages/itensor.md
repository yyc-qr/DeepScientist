# ITensor Tensor Network Library

## Catalog

- Package id: `itensor`
- Domains: `finite_element_engineering`
- Tags: `tensor-networks`, `quantum-many-body`, `dmrg`, `mps`, `cpp`
- Knowledge URL: https://github.com/skilled-scipkg/ITensor
- Source archive URL: https://github.com/skilled-scipkg/ITensor/archive/refs/heads/v3.zip
- Upstream project URL: https://github.com/ITensor/ITensor
- Homepage: http://itensor.org
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

ITensor is a C++ library for efficient tensor network calculations, featuring automatic index-aware contractions for matrix product states and quantum many-body algorithms.
...
appropriate for `itensor`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/itensor_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `itensor` uses
