...
- Tags: `fenicsx`, `finite-element`, `pde`, `hpc`, `multiphysics`
- Knowledge URL: https://github.com/skilled-scipkg/dolfinx
- Source archive URL: https://github.com/skilled-scipkg/dolfinx/archive/refs/heads/main.zip
- Upstream project URL: https://github.com/FEniCS/dolfinx
- Homepage: https://fenicsproject.org
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

DOLFINx is the next generation FEniCSx environment for parallel finite element solution of partial differential equations through interoperable C++ and Python interfaces.
...
```bash
command -v dolfinx || true
dolfinx --version || true
```

If the package is available only through environment modules, record the module
state and the exact executable path in `validation/environment/dolfinx_doctor.json`.
...
Generated import or executable names are starting points. If `dolfinx` uses
