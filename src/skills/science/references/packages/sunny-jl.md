...
- Tags: `magnetism`, `spin-waves`, `spin-dynamics`, `quantum-materials`, `scattering`
- Knowledge URL: https://github.com/skilled-scipkg/Sunny.jl
- Source archive URL: https://github.com/skilled-scipkg/Sunny.jl/archive/refs/heads/main.zip
- Upstream project URL: https://github.com/SunnySuite/Sunny.jl
- Homepage: https://sunnysuite.github.io/Sunny.jl/
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

Sunny.jl models magnetic materials with symmetry-aware Hamiltonians, quantum spin excitations, finite-temperature spin dynamics, and fitting to neutron or X-ray scattering data.
...
appropriate for `sunny-jl`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/sunny-jl_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `sunny-jl` uses
