# Quantica.jl Lattice Quantum Systems

## Catalog

- Package id: `quantica-jl`
- Domains: `quantum_chemistry`
- Tags: `quantum-physics`, `lattice-models`, `tight-binding`, `condensed-matter`, `quantum-transport`, `julia`
- Knowledge URL: https://github.com/skilled-scipkg/Quantica.jl
- Source archive URL: https://github.com/skilled-scipkg/Quantica.jl/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/pablosanjose/Quantica.jl
- Homepage: https://github.com/pablosanjose/Quantica.jl
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

Quantica.jl is a Julia package for building lattice tight-binding Hamiltonians and computing band structures, Green functions, and transport observables for quantum condensed-matter systems.
...
appropriate for `quantica-jl`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/quantica-jl_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `quantica-jl` uses
