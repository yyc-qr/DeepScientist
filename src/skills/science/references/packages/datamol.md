...
- Tags: `cheminformatics`, `molecular-processing`, `rdkit`, `small-molecules`, `molecular-io`
- Knowledge URL: https://github.com/skilled-scipkg/datamol
- Source archive URL: https://github.com/skilled-scipkg/datamol/archive/refs/heads/main.zip
- Upstream project URL: https://github.com/datamol-io/datamol
- Homepage: https://docs.datamol.io
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

Datamol is a lightweight RDKit-first toolkit for molecular standardization, structure conversion, fingerprints, conformer generation, visualization, and molecule file I/O with practical defaults for cheminformatics workflows.
...
Generated import or executable names are starting points. If `datamol` uses
