...
- Package id: `pylith`
- Domains: `finite_element_engineering`
- Tags: `geodynamics`, `finite-element`, `tectonics`, `earthquake-modeling`, `crustal-deformation`, `seismology`
- Knowledge URL: https://github.com/skilled-scipkg/pylith
- Source archive URL: https://github.com/skilled-scipkg/pylith/archive/refs/heads/main.zip
- Upstream project URL: https://github.com/geodynamics/pylith
- Homepage: https://github.com/geodynamics/pylith
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

PyLith is a finite-element geodynamics package for quasi-static and dynamic simulation of crustal deformation, including earthquake rupture, fault friction, viscoelastic rheology, and volcano-related tectonic processes.
...
```bash
command -v pylith || true
pylith --version || true
```

If the package is available only through environment modules, record the module
state and the exact executable path in `validation/environment/pylith_doctor.json`.
...
Generated import or executable names are starting points. If `pylith` uses
