# Pybinding Tight Binding Toolkit

## Catalog

- Package id: `pybinding`
- Domains: `quantum_chemistry`
- Tags: `computational-physics`, `condensed-matter`, `tight-binding`, `electronic-structure`, `quantum-transport`
- Knowledge URL: https://github.com/skilled-scipkg/pybinding
- Source archive URL: https://github.com/skilled-scipkg/pybinding/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/dean0x7d/pybinding
- Homepage: https://pybinding.site
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

pybinding is a scientific Python library for constructing and solving tight-binding models of crystalline materials to study electronic structure and quantum transport in solid-state systems.
...
appropriate for `pybinding`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/pybinding_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `pybinding` uses
