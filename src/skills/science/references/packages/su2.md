...
- Tags: `cfd`, `aerodynamics`, `multiphysics`, `pde`, `optimization`, `simulation`
- Knowledge URL: https://github.com/skilled-scipkg/SU2
- Source archive URL: https://github.com/skilled-scipkg/SU2/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/su2code/SU2
- Homepage: https://su2code.github.io
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

SU2 is an open-source C++ suite for computational fluid dynamics, multiphysics PDE simulation, and adjoint-driven aerodynamic shape optimization for engineering analysis and design.
...
state and the exact executable path in `validation/environment/su2_doctor.json`.
...
Generated import or executable names are starting points. If `su2` uses
