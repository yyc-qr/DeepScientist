...
- Package id: `astroquery`
- Domains: `astronomy_astrophysics`
- Tags: `astronomy`, `astroinformatics`, `catalog-query`, `archive-access`, `observational-data`, `astropy-affiliated`
- Knowledge URL: https://github.com/skilled-scipkg/astroquery
- Source archive URL: https://github.com/skilled-scipkg/astroquery/archive/refs/heads/main.zip
- Upstream project URL: https://github.com/astropy/astroquery
...
Astroquery provides a unified Python interface for querying online astronomical catalogs, mission archives, and object databases through service-specific modules and standardized query methods.
...
Generated import or executable names are starting points. If `astroquery` uses
