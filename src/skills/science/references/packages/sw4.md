...
- Tags: `sw4`, `seismology`, `geophysics`, `seismic-modeling`, `elastic-waves`, `finite-difference`, `earthquake-simulation`
- Knowledge URL: https://github.com/skilled-scipkg/sw4
- Source archive URL: https://github.com/skilled-scipkg/sw4/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/geodynamics/sw4
...
SW4 is a high-order solver for 3D seismic wave propagation with free-surface and absorbing boundaries, supporting point-force and moment-tensor earthquake source modeling.
...
under `validation/environment/sw4_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `sw4` uses
