...
- Tags: `openmoc`, `nuclear`, `reactor-physics`, `neutron-transport`, `moc`, `core-simulation`
- Knowledge URL: https://github.com/skilled-scipkg/OpenMOC
- Source archive URL: https://github.com/skilled-scipkg/OpenMOC/archive/refs/heads/develop.zip
- Upstream project URL: https://github.com/mit-crpg/OpenMOC
...
OpenMOC is a deterministic method-of-characteristics simulator for neutron transport in nuclear reactors, computing flux, power distribution, and multiplication factors for fixed-source and eigenvalue problems.
...
appropriate for `openmoc`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/openmoc_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `openmoc` uses
