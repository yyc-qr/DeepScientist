...
- Tags: `quantum-physics`, `open-quantum-systems`, `quantum-optics`, `master-equation`, `numerical-simulation`
- Knowledge URL: https://github.com/skilled-scipkg/qutip
- Source archive URL: https://github.com/skilled-scipkg/qutip/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/qutip/qutip
- Homepage: https://qutip.org
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

QuTiP is a Python framework for simulating closed and open quantum system dynamics with Hamiltonians, collapse operators, and time-dependent master-equation solvers used in quantum optics and information research.
...
appropriate for `qutip`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/qutip_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `qutip` uses
