# DART Robotics Dynamics Engine

## Catalog

- Package id: `dart`
- Domains: `robotics_physics`
- Tags: `robotics`, `physics-engine`, `dynamics`, `simulation`, `multibody`, `collision`
- Knowledge URL: https://github.com/skilled-scipkg/dart
- Source archive URL: https://github.com/skilled-scipkg/dart/archive/refs/heads/main.zip
- Upstream project URL: https://github.com/dartsim/dart
...
DART is a C++20 robotics and animation dynamics engine with stable articulated rigid-body simulation, collision and constraint handling, and Python bindings via dartpy.
...
appropriate for `dart`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/dart_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `dart` uses
