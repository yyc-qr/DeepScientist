...
- Package id: `swift`
- Domains: `astronomy_astrophysics`, `computational_fluid_dynamics`, `workflow_provenance`, `robotics_physics`
- Tags: `astrophysics`, `cosmology`, `hydrodynamics`, `sph`, `gravity`, `hpc`
- Knowledge URL: https://github.com/skilled-scipkg/SWIFT
- Source archive URL: https://github.com/skilled-scipkg/SWIFT/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/SWIFTSIM/SWIFT
- Homepage: http://www.swiftsim.com
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

SWIFT is a high-performance astrophysics engine for cosmological particle simulations, combining gravity and smoothed particle hydrodynamics with fine-grained tasking across large HPC systems.
...
Generated import or executable names are starting points. If `swift` uses
