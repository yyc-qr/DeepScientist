# Drake Robotics Toolkit

## Catalog

- Package id: `drake`
- Domains: `robotics_physics`
- Tags: `robotics`, `simulation`, `multibody`, `optimization`, `control`, `planning`
- Knowledge URL: https://github.com/skilled-scipkg/drake
- Source archive URL: https://github.com/skilled-scipkg/drake/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/RobotLocomotion/drake
- Homepage: https://drake.mit.edu
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

Drake is an open-source robotics toolbox for model-based design, simulation, planning, control, and verification of complex robotic systems.
...
appropriate for `drake`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/drake_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `drake` uses
