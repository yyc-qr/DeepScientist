# atomSmltr Laser Cooling and Trapping Simulator

## Catalog

- Package id: `atomsmltr`
- Domains: `computational_science`
- Tags: `atomic-physics`, `laser-cooling`, `cold-atoms`, `magneto-optical-trap`, `numerical-simulation`
- Knowledge URL: https://github.com/skilled-scipkg/atomSmltr
- Source archive URL: https://github.com/skilled-scipkg/atomSmltr/archive/refs/heads/main.zip
- Upstream project URL: https://github.com/adareau/atomSmltr
- Homepage: https://atomsmltr.readthedocs.io/en/latest/
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

atomSmltr is a modular Python toolkit for simulating laser-cooled atoms in custom laser and magnetic field geometries with trajectory integration.
...
appropriate for `atomsmltr`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/atomsmltr_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `atomsmltr` uses
