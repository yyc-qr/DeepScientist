...
- Package id: `kadanoffbaym-jl`
- Domains: `computational_science`
- Tags: `julia`, `nonequilibrium`, `many-body`, `quantum-dynamics`, `green-functions`, `kadanoff-baym`
- Knowledge URL: https://github.com/skilled-scipkg/KadanoffBaym.jl
- Source archive URL: https://github.com/skilled-scipkg/KadanoffBaym.jl/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/NonequilibriumDynamics/KadanoffBaym.jl
...
Julia package for adaptive numerical integration of nonequilibrium Kadanoff-Baym equations and real-time Green function dynamics in many-body quantum systems.
...
appropriate for `kadanoffbaym-jl`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/kadanoffbaym-jl_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `kadanoffbaym-jl` uses
