...
- Tags: `groundwater`, `hydrology`, `hydrogeology`, `usgs`, `modflow`, `aquifer-modeling`
- Knowledge URL: https://github.com/skilled-scipkg/modflow6
- Source archive URL: https://github.com/skilled-scipkg/modflow6/archive/refs/heads/develop.zip
- Upstream project URL: https://github.com/MODFLOW-ORG/modflow6
- Homepage: https://modflow6.readthedocs.io/
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

MODFLOW 6 is the USGS modular hydrologic simulator for groundwater flow and transport, supporting integrated surface-water interactions, time-varying stresses, and extensible packages for basin-scale hydrogeologic modeling.
...
appropriate for `modflow6`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/modflow6_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `modflow6` uses
