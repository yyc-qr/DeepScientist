...
- Tags: `finite-element`, `pde`, `scientific-computing`, `hpc`, `cpp`, `amr`
- Knowledge URL: https://github.com/skilled-scipkg/mfem
- Source archive URL: https://github.com/skilled-scipkg/mfem/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/mfem/mfem
- Homepage: http://mfem.org
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

MFEM is a modular, scalable C++ finite element library for high-order PDE discretization, adaptive meshing, and MPI/GPU-enabled scientific simulation from laptops to supercomputers.
...
state and the exact executable path in `validation/environment/mfem_doctor.json`.
...
Generated import or executable names are starting points. If `mfem` uses
