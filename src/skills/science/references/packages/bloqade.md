...
- Tags: `quantum-computing`, `neutral-atoms`, `rydberg`, `quantum-sdk`, `edsl`, `quera`
- Knowledge URL: https://github.com/skilled-scipkg/bloqade
- Source archive URL: https://github.com/skilled-scipkg/bloqade/archive/refs/heads/main.zip
- Upstream project URL: https://github.com/QuEraComputing/bloqade
- Homepage: https://bloqade.quera.com/latest/
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

Bloqade is QuEra's Python SDK and eDSL suite for programming, compiling, and simulating neutral-atom quantum computing workflows on Rydberg-atom hardware and related backends.
...
appropriate for `bloqade`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/bloqade_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `bloqade` uses
