...
- Tags: `chemical-kinetics`, `reaction-mechanism-generation`, `combustion`, `thermochemistry`, `atmospheric-chemistry`, `arkane`
- Knowledge URL: https://github.com/skilled-scipkg/RMG-Py
- Source archive URL: https://github.com/skilled-scipkg/RMG-Py/archive/refs/heads/main.zip
- Upstream project URL: https://github.com/ReactionMechanismGenerator/RMG-Py
- Homepage: http://reactionmechanismgenerator.github.io/RMG-Py/
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

RMG-Py automatically builds detailed chemical kinetic mechanisms and thermochemistry models for combustion, pyrolysis, and atmospheric reaction networks, with Arkane support for pressure-dependent and high-pressure-limit kinetics.
...
appropriate for `rmg-py`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/rmg-py_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `rmg-py` uses
