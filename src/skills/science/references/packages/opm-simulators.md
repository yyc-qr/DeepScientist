...
- Package id: `opm-simulators`
- Domains: `computational_science`
- Tags: `reservoir-simulation`, `porous-media`, `black-oil`, `co2-storage`, `hydrogen-storage`, `well-modeling`
- Knowledge URL: https://github.com/skilled-scipkg/opm-simulators
- Source archive URL: https://github.com/skilled-scipkg/opm-simulators/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/OPM/opm-simulators
- Homepage: http://www.opm-project.org
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

Open Porous Media simulators provide fully implicit reservoir modeling for black-oil production, CO2 and hydrogen storage, thermal, solvent, and polymer processes using Eclipse-compatible input decks at industrial scale.
...
appropriate for `opm-simulators`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/opm-simulators_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `opm-simulators` uses
