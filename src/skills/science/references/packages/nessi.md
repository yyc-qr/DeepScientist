# NESSi Non-Equilibrium Systems Simulation

## Catalog

- Package id: `nessi`
- Domains: `computational_science`
- Tags: `many-body-physics`, `nonequilibrium`, `green-functions`, `quantum-dynamics`, `kadanoff-baym`, `condensed-matter`
- Knowledge URL: https://github.com/skilled-scipkg/nessi
- Source archive URL: https://github.com/skilled-scipkg/nessi/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/nessi-cntr/nessi
...
NESSi is an open-source package for simulating nonequilibrium many-body dynamics using contour-ordered Green's functions on the Kadanoff-Baym contour with equation-of-motion solvers and scalable reciprocal-space parallelization.
...
appropriate for `nessi`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/nessi_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `nessi` uses
