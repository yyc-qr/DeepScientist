...
- Tags: `quantum`, `circuit`, `simulation`, `variational`, `nisq`
- Knowledge URL: https://github.com/skilled-scipkg/qulacs
- Source archive URL: https://github.com/skilled-scipkg/qulacs/archive/refs/heads/main.zip
- Upstream project URL: https://github.com/qulacs/qulacs
...
Qulacs is a high performance C++ and Python library for simulating large noisy and parametric gate based quantum circuits with multithreaded CPU and optional CUDA acceleration for variational quantum computing research.
...
appropriate for `qulacs`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/qulacs_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `qulacs` uses
