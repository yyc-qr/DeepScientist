# LIMIX Genomic Linear Mixed Models

## Catalog

- Package id: `limix`
- Domains: `bioinformatics`, `workflow_provenance`
- Tags: `genomics`, `statistical-genetics`, `linear-mixed-models`, `gwas`, `eqtl`, `association-testing`
- Knowledge URL: https://github.com/skilled-scipkg/limix
- Source archive URL: https://github.com/skilled-scipkg/limix/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/limix/limix
...
LIMIX provides efficient linear mixed model methods for genomic association, interaction, and variance decomposition analyses, supporting workflows such as single-variant tests, set tests, and eQTL-style statistical genetics studies.
...
appropriate for `limix`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/limix_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `limix` uses
