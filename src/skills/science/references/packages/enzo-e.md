...
- Tags: `astrophysics`, `cosmology`, `amr`, `hpc`, `hydrodynamics`, `simulation`
- Knowledge URL: https://github.com/skilled-scipkg/enzo-e
- Source archive URL: https://github.com/skilled-scipkg/enzo-e/archive/refs/heads/main.zip
- Upstream project URL: https://github.com/enzo-project/enzo-e
- Homepage: https://github.com/enzo-project/enzo-e
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

Enzo-E is an exascale-oriented astrophysics and cosmology simulation code built on the Cello AMR framework for massively parallel hydrodynamics and structure-formation studies.
...
Generated import or executable names are starting points. If `enzo-e` uses
