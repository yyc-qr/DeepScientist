# Astropy Astronomy Core Library

## Catalog

- Package id: `astropy`
- Domains: `astronomy_astrophysics`, `workflow_provenance`
- Tags: `astronomy`, `astrophysics`, `fits`, `coordinates`, `cosmology`, `units`
- Knowledge URL: https://github.com/skilled-scipkg/astropy
- Source archive URL: https://github.com/skilled-scipkg/astropy/archive/refs/heads/main.zip
- Upstream project URL: https://github.com/astropy/astropy
- Homepage: https://www.astropy.org
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

Astropy is the core Python library for astronomy, covering units, coordinates, time handling, FITS files, WCS, tables, and cosmology workflows.
...
Generated import or executable names are starting points. If `astropy` uses
