...
- Package id: `dftb`
- Domains: `quantum_chemistry`, `molecular_dynamics`
- Tags: `quantum-chemistry`, `electronic-structure`, `atomistic-simulation`, `tight-binding`, `materials-modeling`
- Knowledge URL: https://github.com/skilled-scipkg/dftbplus
- Source archive URL: https://github.com/skilled-scipkg/dftbplus/archive/refs/heads/main.zip
- Upstream project URL: https://github.com/TEL-Research/dftbplus
- Homepage: http://www.dftbplus.org
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

DFTB+ performs fast quantum-mechanical atomistic simulations using density functional tight binding for efficient electronic-structure, molecular dynamics, and materials calculations with Slater-Koster parameter sets.
...
Generated import or executable names are starting points. If `dftb` uses
