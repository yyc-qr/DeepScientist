...
- Package id: `mujoco`
- Domains: `robotics_physics`
- Tags: `physics-simulation`, `robotics`, `rigid-body-dynamics`, `contact-dynamics`, `biomechanics`, `optimal-control`
- Knowledge URL: https://github.com/skilled-scipkg/mujoco
- Source archive URL: https://github.com/skilled-scipkg/mujoco/archive/refs/heads/main.zip
- Upstream project URL: https://github.com/google-deepmind/mujoco
- Homepage: https://mujoco.org
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

MuJoCo is a high-performance multi-joint rigid-body physics engine for contact-rich simulation in robotics, biomechanics, control, and differentiable dynamics research.
...
appropriate for `mujoco`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/mujoco_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `mujoco` uses
