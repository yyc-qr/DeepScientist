...
- Package id: `pynbody`
- Domains: `astronomy_astrophysics`, `computational_fluid_dynamics`
- Tags: `astrophysics`, `cosmology`, `nbody`, `hydrodynamics`, `simulation-analysis`, `amr`
- Knowledge URL: https://github.com/skilled-scipkg/pynbody
- Source archive URL: https://github.com/skilled-scipkg/pynbody/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/pynbody/pynbody
- Homepage: https://pynbody.readthedocs.io
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

Python framework for analyzing and visualizing N-body and hydrodynamic astrophysical simulation data, including Gadget, Gasoline, Arepo, N-Chilada, and RAMSES AMR outputs.
...
Generated import or executable names are starting points. If `pynbody` uses
