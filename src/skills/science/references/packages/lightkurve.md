# Lightkurve Kepler and TESS Light-Curve Analysis

## Catalog

- Package id: `lightkurve`
- Domains: `astronomy_astrophysics`
- Tags: `astronomy`, `photometry`, `time-series`, `exoplanets`, `kepler`, `tess`
- Knowledge URL: https://github.com/skilled-scipkg/lightkurve
- Source archive URL: https://github.com/skilled-scipkg/lightkurve/archive/refs/heads/main.zip
- Upstream project URL: https://github.com/lightkurve/lightkurve
...
Lightkurve offers user-friendly tools to retrieve, clean, visualize, and analyze Kepler and TESS astronomical flux time series, including light curves and target pixel files for exoplanet and stellar variability studies.
...
Generated import or executable names are starting points. If `lightkurve` uses
