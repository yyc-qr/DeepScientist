# Meep Electromagnetic FDTD Simulator

## Catalog

- Package id: `meep`
- Domains: `electromagnetics`
- Tags: `electromagnetics`, `fdtd`, `photonics`, `nanophotonics`, `maxwell`, `wave-optics`
- Knowledge URL: https://github.com/skilled-scipkg/meep
- Source archive URL: https://github.com/skilled-scipkg/meep/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/NanoComp/meep
...
Meep is an open-source finite-difference time-domain simulator for modeling electromagnetic wave propagation, resonances, and scattering in photonic structures across 1D, 2D, 3D, and cylindrical geometries.
...
state and the exact executable path in `validation/environment/meep_doctor.json`.
...
Generated import or executable names are starting points. If `meep` uses
