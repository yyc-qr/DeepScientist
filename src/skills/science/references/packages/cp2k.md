...
- Tags: `cp2k`, `quantum-chemistry`, `electronic-structure`, `dft`, `molecular-dynamics`, `solid-state`
- Knowledge URL: https://github.com/skilled-scipkg/cp2k
- Source archive URL: https://github.com/skilled-scipkg/cp2k/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/cp2k/cp2k
- Homepage: https://www.cp2k.org
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

CP2K is an atomistic simulation package for quantum chemistry and solid-state physics, supporting DFT and beyond for molecular, periodic, and materials systems with efficient parallel execution.
...
Generated import or executable names are starting points. If `cp2k` uses
