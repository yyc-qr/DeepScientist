...
- Tags: `robotics`, `simulation`, `physics`, `sensors`, `gazebo`, `autonomy`
- Knowledge URL: https://github.com/skilled-scipkg/gz-sim
- Source archive URL: https://github.com/skilled-scipkg/gz-sim/archive/refs/heads/gz-sim10.zip
- Upstream project URL: https://github.com/gazebosim/gz-sim
- Homepage: https://gazebosim.org
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

Open-source robotics simulator for high-fidelity physics, 3D rendering, and sensor modeling, enabling virtual robot testing through GUI, plugins, command-line tools, and distributed transport interfaces.
...
appropriate for `gz-sim`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/gz-sim_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `gz-sim` uses
