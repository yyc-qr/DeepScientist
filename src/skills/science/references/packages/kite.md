# KITE Quantum Transport Suite

## Catalog

- Package id: `kite`
- Domains: `quantum_chemistry`, `workflow_provenance`
- Tags: `quantum-transport`, `tight-binding`, `electronic-structure`, `condensed-matter`, `hpc`, `disorder`
- Knowledge URL: https://github.com/skilled-scipkg/kite
- Source archive URL: https://github.com/skilled-scipkg/kite/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/quantum-kite/kite
- Homepage: https://quantum-kite.com
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

KITE is a Python/C++ package for large-scale real-space tight-binding simulations of electronic structure and bulk quantum transport in disordered materials, including DC/AC conductivity, DoS, and wave-packet dynamics.
...
state and the exact executable path in `validation/environment/kite_doctor.json`.
...
Generated import or executable names are starting points. If `kite` uses
