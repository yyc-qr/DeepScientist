# MC/DC Neutron Transport

## Catalog

- Package id: `mcdc`
- Domains: `high_energy_physics`
- Tags: `neutron-transport`, `monte-carlo`, `reactor-physics`, `radiation-transport`, `computational-physics`
- Knowledge URL: https://github.com/skilled-scipkg/MCDC
- Source archive URL: https://github.com/skilled-scipkg/MCDC/archive/refs/heads/dev.zip
- Upstream project URL: https://github.com/CEMeNT-PSAAP/MCDC
...
MC/DC is a scalable Monte Carlo neutron transport package for fully transient reactor and radiation simulations, enabling rapid methods development with performant, machine-portable Python implementations.
...
appropriate for `mcdc`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/mcdc_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `mcdc` uses
