# Chemicals Thermophysical Data Library

## Catalog

- Package id: `chemicals`
- Domains: `workflow_provenance`
- Tags: `chemical-engineering`, `thermodynamics`, `property-database`, `phase-equilibrium`, `thermophysical-properties`, `process-simulation`
- Knowledge URL: https://github.com/skilled-scipkg/chemicals
- Source archive URL: https://github.com/skilled-scipkg/chemicals/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/CalebBell/chemicals
...
Python library with on-demand databases and correlations for pure-component constants, thermophysical properties, safety information, and phase-equilibrium calculations used in chemical engineering workflows.
...
under `validation/environment/chemicals_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `chemicals` uses
