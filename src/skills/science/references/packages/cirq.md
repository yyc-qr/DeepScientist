...
- Tags: `cirq`, `quantum`, `nisq`, `quantum-circuits`, `simulation`
- Knowledge URL: https://github.com/skilled-scipkg/Cirq
- Source archive URL: https://github.com/skilled-scipkg/Cirq/archive/refs/heads/main.zip
- Upstream project URL: https://github.com/quantumlib/Cirq
...
Cirq is a Python framework for building, transforming, and simulating noisy intermediate-scale quantum circuits on simulators and hardware-aware quantum devices.
...
appropriate for `cirq`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/cirq_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `cirq` uses
