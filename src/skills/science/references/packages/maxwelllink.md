# MaxwellLink Light-Matter Co-Simulation

## Catalog

- Package id: `maxwelllink`
- Domains: `molecular_dynamics`, `electromagnetics`, `workflow_provenance`
- Tags: `light-matter`, `electrodynamics`, `multiphysics`, `molecular-dynamics`, `quantum-dynamics`, `hpc`
- Knowledge URL: https://github.com/skilled-scipkg/MaxwellLink
- Source archive URL: https://github.com/skilled-scipkg/MaxwellLink/archive/refs/heads/main.zip
- Upstream project URL: https://github.com/TaoELi/MaxwellLink
- Homepage: https://taoeli.github.io/MaxwellLink/
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

MaxwellLink is a modular Python framework for self-consistent electromagnetic molecular co-simulation, coupling EM solvers with quantum, force-field, and first-principles molecular dynamics drivers.
...
```bash
command -v maxwelllink || true
maxwelllink --version || true
```

If the package is available only through environment modules, record the module
state and the exact executable path in `validation/environment/maxwelllink_doctor.json`.
...
Generated import or executable names are starting points. If `maxwelllink` uses
