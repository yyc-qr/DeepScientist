...
- Tags: `quantum-transport`, `tight-binding`, `mesoscopic-physics`, `condensed-matter`, `nanodevices`, `quantum-simulation`
- Knowledge URL: https://github.com/skilled-scipkg/kwant
- Source archive URL: https://github.com/skilled-scipkg/kwant/archive/refs/heads/main.zip
- Upstream project URL: https://github.com/kwant-project/kwant
- Homepage: https://kwant-project.org/
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

Kwant is an open-source Python package for numerical calculations on tight-binding models with a strong focus on quantum transport in mesoscopic systems.
...
appropriate for `kwant`.

## Package Check

Use a package-specific import, executable, or module check and save the result
under `validation/environment/kwant_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `kwant` uses
