# PLINK 2 Genome Association Toolkit

## Catalog

- Package id: `plink-ng`
- Domains: `bioinformatics`, `workflow_provenance`
- Tags: `genomics`, `gwas`, `population-genetics`, `bioinformatics`, `variant-analysis`
- Knowledge URL: https://github.com/skilled-scipkg/plink-ng
- Source archive URL: https://github.com/skilled-scipkg/plink-ng/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/chrchang/plink-ng
- Homepage: https://www.cog-genomics.org/plink/2.0/
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

PLINK-NG provides high-performance whole-genome association and population genetics analyses, supporting large cohort genotype, VCF, and dosage datasets for GWAS, quality control, and relatedness workflows.
...
Generated import or executable names are starting points. If `plink-ng` uses
