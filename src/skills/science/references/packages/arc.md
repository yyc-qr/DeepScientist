...
- Tags: `atomic-physics`, `rydberg-atoms`, `alkali-atoms`, `divalent-atoms`, `quantum-optics`, `stark-shifts`
- Knowledge URL: https://github.com/skilled-scipkg/ARC-Alkali-Rydberg-Calculator
- Source archive URL: https://github.com/skilled-scipkg/ARC-Alkali-Rydberg-Calculator/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/nikolasibalic/ARC-Alkali-Rydberg-Calculator
- Homepage: https://atomcalc.org
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

Python toolkit for computing properties of highly excited Rydberg states and interactions in alkali and divalent atoms, including level structure, transition strengths, and electric-field Stark calculations.
...
under `validation/environment/arc_doctor.json` before treating the
runtime as usable.
...
Generated import or executable names are starting points. If `arc` uses
