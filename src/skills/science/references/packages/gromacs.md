...
- Package id: `gromacs`
- Domains: `computational_chemistry`, `molecular_dynamics`, `workflow_provenance`
- Tags: `gromacs`, `molecular-dynamics`, `computational-chemistry`, `biophysics`, `free-energy`, `trajectory-analysis`
- Knowledge URL: https://github.com/skilled-scipkg/gromacs
- Source archive URL: https://github.com/skilled-scipkg/gromacs/archive/refs/heads/main.zip
- Upstream project URL: https://github.com/gromacs/gromacs
- Homepage: http://www.gromacs.org
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

GROMACS is a high-performance molecular dynamics toolkit for simulating biomolecules, polymers, and liquids, with strong support for free-energy workflows and trajectory analysis.
...
```bash
command -v gromacs || true
gromacs --version || true
```

If the package is available only through environment modules, record the module
state and the exact executable path in `validation/environment/gromacs_doctor.json`.
...
Generated import or executable names are starting points. If `gromacs` uses
