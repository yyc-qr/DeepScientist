...
- Tags: `electromagnetics`, `fdtd`, `gpr`, `geophysics`, `simulation`
- Knowledge URL: https://github.com/skilled-scipkg/gprMax
- Source archive URL: https://github.com/skilled-scipkg/gprMax/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/gprMax/gprMax
- Homepage: https://www.gprmax.com
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

gprMax is an open-source 3D finite-difference time-domain simulator for electromagnetic wave propagation, primarily used for ground penetrating radar modelling and subsurface investigations.
...
```bash
command -v gprmax || true
gprmax --version || true
```

If the package is available only through environment modules, record the module
state and the exact executable path in `validation/environment/gprmax_doctor.json`.
...
Generated import or executable names are starting points. If `gprmax` uses
