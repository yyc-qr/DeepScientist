...
- Package id: `deepchem`
- Domains: `quantum_chemistry`, `computational_chemistry`, `materials_science`, `bioinformatics`
- Tags: `cheminformatics`, `drug-discovery`, `molecular-ml`, `quantum-chemistry`, `materials-science`, `computational-biology`
- Knowledge URL: https://github.com/skilled-scipkg/deepchem
- Source archive URL: https://github.com/skilled-scipkg/deepchem/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/deepchem/deepchem
- Homepage: https://deepchem.io/
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

DeepChem provides domain-focused machine learning tools for molecular property prediction, drug discovery, and scientific modeling across chemistry, materials science, quantum chemistry, and biology.
...
Generated import or executable names are starting points. If `deepchem` uses
