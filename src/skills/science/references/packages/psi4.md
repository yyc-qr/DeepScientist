...
- Package id: `psi4`
- Domains: `quantum_chemistry`, `computational_chemistry`, `workflow_provenance`
- Tags: `quantum-chemistry`, `electronic-structure`, `ab-initio`, `computational-chemistry`, `molecular-modeling`
- Knowledge URL: https://github.com/skilled-scipkg/psi4
- Source archive URL: https://github.com/skilled-scipkg/psi4/archive/refs/heads/master.zip
- Upstream project URL: https://github.com/psi4/psi4
- Homepage: http://psicode.org
- Catalog source: FermiLink skilled-scipkg, commit `93f089a333a43089fb1a08a73c37d05fd6683214`

## When To Consider

Psi4 is an open source ab initio quantum chemistry package for high accuracy molecular electronic structure calculations, with performant C++ kernels and Python driven user workflows.
...
Generated import or executable names are starting points. If `psi4` uses
